...
#fileNames
if(process_ ==0): 
	with open('sample/140PU/gamJet.txt','r') as f:
...
process.hgg = cms.EDAnalyzer("HoverEAnalyzer_MVA",
                             ...
                             g4TracksSource    = cms.untracked.string('g4SimHits'),
												...
												MVAweightfile = cms.FileInPath("UserCode/HGCanalysis/data/HGC_PhotonID_BDTG.weights.xml")
		)
