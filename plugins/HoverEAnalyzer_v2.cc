// -*- C++ -*-
//
// Package:    HoverEAnalyzer_v2
// Class:      HoverEAnalyzer_v2
// 
//
//
...
// .h class info
class HoverEAnalyzer_v2 : public edm::EDAnalyzer {
	public:
		explicit HoverEAnalyzer_v2(const edm::ParameterSet&);
		~HoverEAnalyzer_v2();
...
// constructor
HoverEAnalyzer_v2::HoverEAnalyzer_v2(const edm::ParameterSet& iConfig):
...
// destructor
HoverEAnalyzer_v2::~HoverEAnalyzer_v2()
{
...
double HoverEAnalyzer_v2::fillEmIdVars(const edm::Ptr<reco::SuperCluster>& sc,const edm::PtrVector<reco::PFCluster>& clusters,const  edm::PtrVector<reco::PFRecHit>& rcs){
...
float HoverEAnalyzer_v2::resumEmEnergy(const edm::Ptr<reco::SuperCluster>& sc,const edm::PtrVector<reco::PFCluster>& clusters){
...
float HoverEAnalyzer_v2::clusterEmEnergy(const edm::Ptr<reco::CaloCluster>& c,const edm::PtrVector<reco::PFCluster>& clusters){
	...
	void
HoverEAnalyzer_v2::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
	using namespace edm;
  ...
  iSetup.get<CaloTopologyRecord>().get(caloTopo_);
	...
	infoTruth.lengthCompatibility=-999.;
		...
		for (unsigned int isc =0; isc < sclusters.size() ; isc++){ //subloop over sc's to find matches
			...
			if (dR < dRlim3 && dR < dRBest) { // only true if dR is both below limit value and smaller than previous best dR.
				dRBest = dR;
...
// ------------ method called once each job just before starting event loop  ------------
	void 
HoverEAnalyzer_v2::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
	void 
HoverEAnalyzer_v2::endJob() 
{
}

// ------------ method called when starting to processes a run  ------------
	void 
HoverEAnalyzer_v2::beginRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
	void 
HoverEAnalyzer_v2::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
	void 
HoverEAnalyzer_v2::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
	void 
HoverEAnalyzer_v2::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
HoverEAnalyzer_v2::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(HoverEAnalyzer_v2);
